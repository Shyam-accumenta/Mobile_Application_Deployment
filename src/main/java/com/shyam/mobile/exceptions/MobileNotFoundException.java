package com.shyam.mobile.exceptions;
...
public class MobileNotFoundException extends Exception {
	...
	public MobileNotFoundException(Throwable cause) {
		super(cause);
		// TODO Auto-generated constructor stub
	}
	...
	public MobileNotFoundException(String message, Throwable cause, boolean enableSuppression,
